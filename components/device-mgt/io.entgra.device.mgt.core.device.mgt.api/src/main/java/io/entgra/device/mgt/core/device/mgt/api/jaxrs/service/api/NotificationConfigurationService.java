...
@SwaggerDefinition(
        ...
        tags = {
                @Tag(name = "notification_configuration_management")
        }
)
...
public interface NotificationConfigurationService {
    ...
    Response getNotificationConfigurations(
            ...
            @ApiParam(
                    name = "limit",
                    value = "Provide how many notification configuration details you require from the starting pagination index/offset.",
                    required = false,
                    defaultValue = "5")
            @QueryParam("limit")
                    int limit
